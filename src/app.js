...
const menu = [
    {name: '🥗 Салат весенний', price: 60, type: 'salad'},
    {name: '🥗 Салат с копченой курочкой', price: 67, type: 'salad'},
    {name: '🥗 Салат крабовый с апельсином', price: 65, type: 'salad'},
    {name: '🍲 Уха ростовская', price: 85, type: 'soup'},
    {name: '🍲 Суп-пюре с яйцом пашот', price: 75, type: 'soup'},
    {name: '🍲 Мисо-суп', price: 80, type: 'soup'},
    {name: '🍽 Вареники с картофелем', price: 125, type: 'plate_food'},
    {name: '🍽 Печень с соусом Халапеньо', price: 128, type: 'plate_food'},
    {name: '🍽 Жареное филе красной рыбы', price: 143, type: 'plate_food'},
    {name: '🍰 Десерт медовый', price: 55, type: 'dessert'},
];
