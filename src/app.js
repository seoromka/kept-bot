...
const menu = [
    {name: '🥗 Салат с артишоками и яйцом пашот', price: 68, type: 'salad'},
    {name: '🥗 Салат коул-слоу с индейкой', price: 65, type: 'salad'},
    {name: '🥗 Салат с копченой щукой', price: 62, type: 'salad'},
    {name: '🍲 Уха ростовская', price: 85, type: 'soup'},
    {name: '🍲 Щи с говядиной', price: 75, type: 'soup'},
    {name: '🍲 Мисо-суп', price: 80, type: 'soup'},
    {name: '🍽 Жареная куриная грудка', price: 138, type: 'plate_food'},
    {name: '🍽 Кебаб из говядины', price: 145, type: 'plate_food'},
    {name: '🍽 Пельмени из форели', price: 146, type: 'plate_food'},
    {name: '🍰 Пирожное соблазн', price: 52, type: 'dessert'},
];
